...
<div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="{{ route('home') }}"><img src="{{ asset('theme/purpleadmin/assets/images/logo.svg') }}" alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href="{{ route('home') }}"><img src="{{ asset('theme/purpleadmin/assets/images/logo-mini.svg') }}" alt="logo" /></a>
        </div>
...
{{--                            <img src="{{ asset('theme/purpleadmin/assets/images/faces/face1.jpg') }}" alt="image">--}}
                ...
                <li class="nav-item nav-profile">
                    <a href="#" class="nav-link">
                        <div class="nav-profile-image">
                            <img src="{{ asset('theme/purpleadmin/assets/images/faces/face1.jpg') }}" alt="profile">
